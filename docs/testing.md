...
- Latest visual increment：sample 01 detail outer page gutters now include dark low-opacity, non-uniform depth grids with near/far spacing, shallow perspective lines, and pale warm-gray / blue-gray mist; the grid starts lower via `--case-outer-grid-start: 840px`, leaving the upper side area fully transparent, and is hidden below `1180px`.
